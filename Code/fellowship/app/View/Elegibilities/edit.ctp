...
<?php echo $this->Form->create('Elegibility'); ?>
	<fieldset>
		<legend><?php echo __('Edit Elegibility'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Elegibility.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Elegibility.id')))); ?></li>
